...
<?php if($atts['class'] != 'footer') { ?>
	<div class="<?php echo $atts['class']; ?>" id="<?php echo $atts['id']; ?>">
		<?php if($atts['class'] == 'titlemain') {?>
			<div>
				<div class="mainwrap-wide">
					<div class="titlemain-container">
						<?php echo do_shortcode( $content ); ?>
					</div>
				</div>
			</div>
		<?php } elseif($atts['class'] != 'footer') {?>
		<div class="mainwrap">
				<?php echo do_shortcode( $content ); ?>
		</div>
		<?php } ?>
