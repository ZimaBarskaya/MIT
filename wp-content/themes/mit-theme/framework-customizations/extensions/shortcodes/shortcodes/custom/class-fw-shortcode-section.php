...
class FW_Shortcode_Custom extends FW_Shortcode
{
	/**
	 * @internal
	 */
	 ...
	 * @internal
	 */
	public function _filter_add_custom_data( $structure )
	{
		$data['custom'] = $this->get_item_data();
	...
	private function get_shortcode_config()
	{
		...
		return array_merge(
			array(
				...
				'title'       => __('Custom', 'fw'),
				'description' => __('Creates a Custom', 'fw'),
				'title_template' => null,
			),
	...
	/**
	 * Adds data about Custom to be pushed further to the frontend.
	 *
	 * @since 1.3.21
	 */
	...
	public function _action_register_builder_item_types() {
		if (fw_ext('page-builder')) {
			require $this->get_declared_path('/includes/page-builder-custom-item/class-page-builder-custom-item.php');
		}
	}
}
